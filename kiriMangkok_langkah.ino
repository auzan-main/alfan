    ...
    if (te < TS * 0.25)
    {
      ...
      if ((countte == 0 || (te - prevte) >= (TS * 0.25 ))) {
        if (count == 0) {
          ...
          tPa = 0;
          tPi = 0;
          tKa = -7;  //pokoknya ini nanti di plus correctionnya
          tKi = 12.5; 
          ...
          pitchKa = 0;
          pitchKi = 0;
          invers(KANAN, times, 3 - 3.06 , tinggiBadan , 0 , -0.5); //m-nya ini nanti di plus correctionnya
    ...
    else if (te < TS * 0.50 && te >= TS * 0.25)
    {
      if (((te - prevte) >= (TS * 0.25 ))) {
        if (count  == 1) {
          ...
          tPa = 0;
          tPi = 2;
          tKa = tKa + nextGoalRoll;  //-10.5 Hips
          tKi = 9.5;   //10.5 Hips
    ...
    else if (te < TS * 0.75 && te >= TS * 0.5)
    {
      if ((te - prevte) >= (TS * 0.25 )) {
        if (count == 2) {
          ...
          tPa = 0;
          tPi = 3;
          tKa = tKa + nextGoalPitch;  //-15.5 Hips
          tKi = 9.5;   //15.5 Hips
