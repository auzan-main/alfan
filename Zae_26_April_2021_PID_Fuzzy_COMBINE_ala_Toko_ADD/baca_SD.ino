...
//      Serial.println(dataBaru);
  ...
  if(buka){
        ...
        else{Serial.println("buka file Error!!");}
         buka=false;  
         isi2="";
    }
...
//       }
       ...
       else{Serial.println("membuat file gagal!!");}
    timpa=false;
  }
...
void tulisWaktuSD(int nama,int waktu){
  ...
  if(myFile){
    ...
    else{Serial.println("menulis file baru gagal");}  
  }
    ...
    else{Serial.println("menulis file gagal");} 
  }
